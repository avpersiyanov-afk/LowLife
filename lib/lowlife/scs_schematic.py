...
# Отступ от границы: и сверху (насколько ниже границы рамки помещения
# проходит коллектор первой, index=0, панели), и снизу (насколько глубже
# самой нижней линии кабеля должна быть нижняя граница рамки этажа) —
# одно и то же число по требованию пользователя ("между линией и
# границей этажа или стояка 8мм"), не два разных подобранных на глаз
# значения.
