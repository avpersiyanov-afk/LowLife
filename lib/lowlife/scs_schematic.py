...
# X первого (index=0) стояка — левее самой рамки этажа (у неё три левые
# вертикальные линии на LEVEL_LINE_1/2/3_OFFSET_MM = 5+20+10 = 35мм от
# группы помещений, см. sot_schematic._draw_level_frame) — стояк должен
# начинаться ЗА рамкой, а не наезжать на неё.
RISER_BASE_OFFSET_MM = 45.0
