...
TEXT_FIELDS = [
    ...
    # --- ручные цепи (кнопка "Цепи СКС" на CircuitsSCS.panel) ---
    ("cable_type_param", u"[Ручные цепи] Параметр цепи «Проводник» (тип кабеля)",
        u"", False, True),
    ("wire_catalog_marker_param", u"[Ручные цепи] Параметр-признак строки справочника кабелей "
        u"(например «SMNX_Марка»)",
        u"", False, True),
]
