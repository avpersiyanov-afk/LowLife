...
DEFAULTS = {
    ...
    # модального окна). Имя ключа историческое. По умолчанию ВЫКЛ — только
    # кнопка «Переименование выгрузки» вручную; включается Shift+клик по
    # ней (у кого уже сохранено «да» из прежних версий — сохранённое
    # значение сильнее нового умолчания, тоже надо выключить вручную).
    "watch_explorer": False,
    ...
    # (переименовывать нечего). По умолчанию нет — тихо, только в лог.
    "notify_nothing": False,
