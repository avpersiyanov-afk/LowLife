# -*- coding: utf-8 -*-
"""
Тело кнопок ручного построения цепей «панель -> устройства» на панели
«Электрические цепи»: пользователь сам выбирает панель и устройства,
кнопка создаёт по одной отдельной цепи на каждое устройство (аналог
«home run» — без промежуточных узлов и адресации).
