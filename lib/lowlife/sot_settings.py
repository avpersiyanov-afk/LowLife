...
TEXT_FIELDS = [
    ("level_param_name", u"[Уровень] Параметр «Уровень» на устройстве (необязательно; "
        u"если пусто — берётся реальный уровень элемента)",
        u"", False, False),
    ("underground_prefix", u"[Уровень] Буква-маркер подземного этажа (например «П»)",
        u"П", True, False),
    ("room_param_name", u"[Параметры] Параметр «Помещение» (на устройстве и на схемном семействе)",
        u"", True, False),
    ("address_param_name", u"[Параметры] Параметр «Адрес устройства» (на устройстве и на схемном семействе)",
        u"", True, False),
