...
физически за пределами уже нарисованной рамки этажа), `BOUNDARY_MARGIN_MM`
(8мм — по требованию пользователя ОДНО И ТО ЖЕ число и для отступа от
узлов до первой линии кабеля, и для запаса от самой глубокой линии
кабеля до нижней границы рамки — не два разных подобранных на глаз
значения) и `BUS_DROP_SPACING_MM` (4мм — насколько дальше от рамки
