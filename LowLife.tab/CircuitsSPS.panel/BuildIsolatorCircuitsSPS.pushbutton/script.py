...
__doc__ = (
    ...
    "Все выбранные устройства ручного пуска (с «ручной» в имени типа — ИПР) "
    "объединяются в одну общую цепь (в одной цепи может быть несколько ИПР), "
    "остальные выбранные устройства — во вторую общую цепь. У изолятора "
    "максимум 2 цепи — «ручная» и «автоматическая»."
)
__author__ = "Pipers"
