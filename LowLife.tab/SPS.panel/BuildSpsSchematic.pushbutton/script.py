...
__doc__ = (
    ...
    "Если в настройках задана категория «Шкаф»/«Панель» — от каждого узла "
    "схемы (кроме самого шкафа) рисуется линия к нему: горизонтально до "
    "стояка (слева от рамок этажа), по стояку вертикально до уровня шкафа, "
    "затем горизонтально до шкафа. Эти линии не редактируются вручную — на "
