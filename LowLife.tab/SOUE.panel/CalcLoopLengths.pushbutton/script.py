...
__title__ = u"Длины\nшлейфов"
__doc__ = (
    u"Считает длину каждого шлейфа СОУЭ по координатам устройств (ветви от "
    u"изоляторов не возвращаются назад), записывает её в цепь, маркирует "
    u"устройства и проставляет им предыдущий адрес."
)
__author__ = "Pipers"
