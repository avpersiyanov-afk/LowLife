...
__doc__ = (
    ...
    "настройкам «Параметры цепей (общее)» — ничего не зашито в код. Выберите "
    ...
    "Выбор отфильтрован — нельзя случайно захватить аннотации, связанные "
    "файлы, оси, уровни, текст, линии детализации и обобщённые модели.\n\n"
