# -*- coding: utf-8 -*-
__title__ = u"Адреса узлов\nСКУД"
__doc__ = (
    u"Нумерует адреса узлов трассы СКУД по этажу, начиная от контроллеров/"
    u"стояков, и записывает контроллерам и устройствам ближайший адресованный "
    u"узел маршрута."
)
__author__ = "Pipers"
