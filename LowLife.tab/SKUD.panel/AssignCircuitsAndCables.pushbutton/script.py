...
__title__ = u"Цепи\nи кабели"
__doc__ = (
    u"Находит контроллеры СКУД и их цепи, назначает подключённым устройствам "
    u"адрес по маске \"адрес контроллера.N\", выбирает тип проводника по "
    u"категории устройства (из настроек СКУД), пишет имя нагрузки и "
    u"маркирует контроллеры."
)
__author__ = "Pipers"
