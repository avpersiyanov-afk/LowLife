...
__title__ = u"Длины\nи маркировка"
__doc__ = (
    u"Считает длину проводника для каждой цепи контроллер-устройство: по "
    u"катетам (с коэффициентом запаса), если устройство рядом с контроллером, "
    u"иначе по графу адресованных узлов трассы. Пишет длину в трубе/лотке "
    u"раздельно, способ прокладки, марку устройств и список цепей на узлах "
    u"маршрута."
)
__author__ = "Pipers"
