...
__doc__ = (
    u"Тестовая кнопка: выберите контроллер СКУД на виде. Показывает все его "
    u"цепи, все элементы каждой цепи и итоговый список устройств, которые "
    u"BuildSkudSchematic поставит на структурную схему — с подсветкой "
    u"дублей по ElementId."
)
__author__ = "Pipers"
