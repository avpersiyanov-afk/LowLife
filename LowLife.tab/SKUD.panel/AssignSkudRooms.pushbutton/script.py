...
__doc__ = (
    u"Проставляет всем устройствам СКУД параметр имени помещения (как "
    u"«Запись номера помещения» в СПС/СОТ), но по каждой точке прохода берёт "
    ...
    u"настроек «Запись номера помещения» (Shift+клик по той кнопке)."
)
__author__ = "Pipers"
