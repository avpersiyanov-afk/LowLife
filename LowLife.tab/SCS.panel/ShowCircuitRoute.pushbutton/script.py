...
__title__ = u"Маршрут\nцепи"
__doc__ = (
    u"Показывает маршрут выбранной цепи СКС на модели — для визуальной "
    ...
    u"активном виде) через устройство, все узлы/стояки маршрута (по данным "
    u"параметра «Маршрут цепи», записанного кнопкой «Расчёт длины цепи») и "
    u"панель, и выделяет все эти элементы в модели, чтобы их было видно "
