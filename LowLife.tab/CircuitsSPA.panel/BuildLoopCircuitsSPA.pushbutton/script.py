...
__doc__ = (
    ...
    u"Каждой созданной цепи сразу проставляется режим траектории «Все "
    u"устройства» и, по получившейся длине (Revit Length x коэффициент "
    u"запаса, округление до целого), «Длина проводника» и «Способ прокладки»."
)
__author__ = "Pipers"
