...
__title__ = u"Цепи\nшлейфов СПА"
__doc__ = (
    u"Создаёт по одной электрической цепи на каждый шлейф СПА и подключает "
    u"её к своей панели. Шлейф определяется по адресу устройства вида "
    u"\"панель.шлейф.номер\" (например 3.1.2) — та же логика, что у кнопки "
    u"«Цепи шлейфов СПС», но ищет панели и устройства в рабочем наборе с "
    u"ключевым словом «СПА» (у СПС — «СПС»), настройки у систем раздельные. "
    u"Сопутствующие устройства категории «Электроприборы» (РМ/АМ/МДУ, "
    u"подключённые рядом с устройствами СПА) в сборе устройств не участвуют "
    u"— это не адресные устройства шлейфа. Каждой созданной цепи сразу "
