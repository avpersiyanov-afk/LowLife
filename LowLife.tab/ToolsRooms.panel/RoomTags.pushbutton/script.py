...
__doc__ = (
    ...
    u"загруженные марки категории «Марки помещений»). Марки, которые "
    u"показывают «?» (АР удалил/переделал помещение, марка осиротела, "
    u"помещение не окружено, либо голова марки вышла за границы своего "
    u"помещения — частая причина «?», Revit сам её не пересчитывает), "
    u"удаляет, а на освободившееся помещение ставит новую с верной "
    u"головой. На время вставки временно снимается подложка вида — она "
